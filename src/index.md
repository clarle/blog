...
date: 2015-05-31
title: Lorem Ipsum
teaser: Lorem ipsum dolor sit amet, consectetur adipiscing el.
layout: main.html
---
...
```js
// The `pathTo()` function is written in ES3 so it's serializable
// and able to run in all JavaScript environments.
